...
class DataTransformation:
        ...
        try:
            ...
            preprocessor=ColumnTransformer(
                [
                    ...
                    ("cat_pipelinw",cate_pipeline,categorical_column)
                ]
            )
            return preprocessor
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            )  #  pickle file  -- create byte code for object(to transfer accross network)

            return(
                train_arr,
                test_arr,
                self.data_transformation_config.preprocessor_obj_file_path  ## Here Preprocessing object is saved
            )
